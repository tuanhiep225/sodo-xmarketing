...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
    ...
    final ApiError apiError =
        new ApiError(HttpStatus.BAD_REQUEST, ex.getMessage(), ex.getCause().getMessage());
  ...
  public ResponseEntity<Object> handleConstraintViolation(final ConstraintViolationException ex,
    ...
    final ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST, "Validation Error", errors);
    return new ResponseEntity<>(apiError, new HttpHeaders(), apiError.getStatus());
  }

  @ExceptionHandler({SodException.class})
  public ResponseEntity<Object> handleSodException(final SodException ex,
      final WebRequest request) {
    logger.error(ex.getErrorCode() + " : " + ex.getMessage());

    final ApiError apiError =
        new ApiError(HttpStatus.BAD_REQUEST, ex.getMessage(), ex.getErrorCode());
